    ...
    <div className={`w-full py-16 relative ${className ?? ""}`}>
      <div className="relative w-full min-h-[500px] flex flex-col items-center justify-center">
        ...
        <motion.div
          ...
          className="absolute bottom-10 px-6 py-3 rounded-full bg-black/5 border border-black/10 backdrop-blur-md text-black/50 text-sm font-medium uppercase tracking-widest pointer-events-none"
        >
          {dragHintText}
        </motion.div>
      </div>
