...
export function LayeredText({
  ...
  return (
    <div
      ref={containerRef}
      className={`mx-auto py-12 sm:py-32 font-sans font-black tracking-[-2px] uppercase text-black dark:text-white antialiased cursor-pointer overflow-hidden max-w-full ${className}`}
