...
export function GetInTouch() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-screen w-full bg-[#020202] flex flex-col selection:bg-primary selection:text-black overflow-hidden"
    >
      ...
      >
        <div className="flex-1 min-w-0 flex flex-col justify-between pb-12 md:pb-8 w-full">
          ...
          <div className="max-w-4xl lg:-translate-y-8 pr-12">
            <h1 className="text-[clamp(3.5rem,9.5vw,11.5rem)] font-black leading-[0.87] tracking-tighter text-white uppercase font-rajdhani">
            ...
            <p className="mt-8 font-mono text-[11px] text-white/40 uppercase tracking-[0.35em] max-w-sm leading-relaxed">
              Connect with Pakistan&apos;s longest-running student EV team. Sponsorships, media, and collaborations welcome.
            </p>
          </div>

          <a
            ref={ctaRef}
            href="mailto:hammerheadgiki@gmail.com"
            className="w-fit flex items-center gap-6 group lg:-translate-y-20"
          >
            <div className="w-14 h-14 rounded-full border border-white/15 flex items-center justify-center group-hover:bg-primary transition-all duration-500 overflow-hidden">
              <svg
                width="18"
                height="18"
                viewBox="0 0 24 24"
        ...
        <div className="w-full md:w-80 lg:w-96 flex-shrink-0 flex flex-col gap-4 justify-center z-20">
          {[
            ...
            { id: "002", title: "TEAM STATS", val: "12+ Years", type: "data" as const },
            { id: "003", title: "EXPERTISE", val: "EV Prototypes", type: "text" as const },
          ].map((item) => (
              ...
              {item.type === "progress" ? (
                <div className="flex justify-between items-end mt-2">
                  ...
                  <div className="h-[2px] w-20 bg-white/5 rounded-full overflow-hidden">
                    <div className="h-full bg-primary w-[60%] animate-loading" />
                  </div>
                </div>
              ) : item.type === "data" ? (
                ...
                <h3 className="text-sm font-medium text-white/70 mt-3 leading-snug">
                  Engineering ultra-efficient vehicles for the{" "}
                  <span className="italic text-white">Shell Eco-Marathon</span>.
                </h3>
              )}
            </div>
          ))}
